...
import static com.subliminallysublime.notenoughcombat.NECEventHandler.*;

/**
 * Created by Andrew on 7/15/2017 at 8:16 PM.
 */
public class ArmorEnderObsidian extends NECArmor
{
	...
	public String getArmorTexture(ItemStack stack, Entity entity, EntityEquipmentSlot slot, String type)
	{
		if(stack.getItem() == NECArmorRegistry.helmetEnderObsidian || stack.getItem() == NECArmorRegistry.chestplateEnderObsidian || stack.getItem() == NECArmorRegistry.bootsEnderObsidian)
			return NotEnoughCombatMod.MODID + ":textures/models/armor/armor_ender_obsidian_layer_0.png";
		else if(stack.getItem() == NECArmorRegistry.leggingsEnderObsidian)
			return NotEnoughCombatMod.MODID + ":textures/models/armor/armor_ender_obsidian_layer_1.png";
		else
	...
	public void onArmorTick(World world, EntityPlayer player, ItemStack itemStack)
	{
		...
		if(player.world.isRemote)
		{
			...
			if(NotEnoughCombatMod.RANDOM.nextInt(5) == 0)
